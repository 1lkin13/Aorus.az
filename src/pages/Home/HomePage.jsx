  ...
  return (
    <>
      ...
      <div className="w-full  bg-slate-50  mt-10">
        ...
        <div className="flex flex-wrap h-auto justify-around bg-slate-50 relative">
      ...
      <h1 className="text-center font-bold text-3xl font-sans mt-16   h-8">Onlar Bizi Seçdilər</h1>
